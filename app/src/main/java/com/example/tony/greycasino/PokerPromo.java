...
class PokerPromo extends AppCompatActivity implements AdapterEvent.OnEventClick {

    String url = "http://www.greyrockcasino.com/en/poker/promotion";
...
//        });
        ...
        Toast.makeText(this, "Poker Promotions ... ", Toast.LENGTH_SHORT).show();
